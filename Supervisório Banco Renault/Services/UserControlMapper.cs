...
namespace Supervisório_Banco_Renault.Services
{
    ...
    public class UserControlMapper
    {
        ...
        public UserControlMapper()
        {
            ...
            RegisterMapping<RecipesManagerVM, RecipesManager>();
            RegisterMapping<UsersManagerVM, UsersManager>();
            RegisterMapping<LabelsManagerVM, LabelsManager>();
            ...
            RegisterMapping<OP10_TraceabilityVM, OP10_Traceability>();

            //Defining the view for each OP20 VM
            RegisterMapping<OP20_AutomaticVM, OP20_Automatic>();
            RegisterMapping<OP20_ManualVM, OP20_Manual>();
            RegisterMapping<OP20_TraceabilityVM, OP20_Traceability>();
        }
